  ...
  <footer class="max-w-6xl mx-auto px-6 py-20">
    <div class="flex justify-between items-center">
      <div>
        ...
        <a href="/signup" class="inline-flex items-center space-x-2 bg-white/10 hover:bg-white/20 rounded-full px-6 py-3 transition-colors">
    ...
    <div class="mt-8 text-sm text-white/60">UMHackathon 2025©</div>
  </footer>