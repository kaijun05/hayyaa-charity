  ...
  <div class="application-form">
    ...
    <div class="form-grid">
      <div>
        ...
        <input id="fullName" type="text" bind:value={fullName} placeholder="Full Name" required class="input" />
      </div>
    
      <div>
        <label for="icNumber" class="form-label">Enter your IC number *</label>
        <input id="icNumber" type="text" bind:value={icNumber} placeholder="IC Number" required class="input" />
      </div>
      ...
      <div>
        ...
        <input id="address" type="text" bind:value={address} placeholder="Address" required class="input" />
      </div>
    
      <div>
        <label for="monthlyIncome" class="form-label">Enter your monthly income (RM) *</label>
        <input id="monthlyIncome" type="number" bind:value={monthlyIncome} placeholder="Monthly Income" required class="input" />
      </div>
    
      <div>
        <label for="householdSize" class="form-label">Enter your household size *</label>
        <input id="householdSize" type="number" bind:value={householdSize} placeholder="Household Size" required class="input" />
      </div>
    ...
    {/if}
      ...
      <div>
        <label for="remarks" class="form-label">Remarks: Explain your situation, needs, or circumstances</label>
